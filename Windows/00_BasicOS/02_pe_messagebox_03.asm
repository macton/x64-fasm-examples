; 02_pe_messagebox_03.asm
;   - Embed BSS (.bss) in CODE (.code) section
...
print_value_x32 "FILE_SIZE = ", FILE_SIZE
  ...
  ;
  ; BSS (.bss) embedded inside of CODE (.code) section
  ; - Note characteristics of .code section changed (+uninitialized-data)
  ;

  rq 1024 ; Just putting some extra padding in here to validate things aren't working accidentally.
...
IMAGE_SIZE = CODE + (((CODE_IMAGE_SIZE+(SECTION_ALIGNMENT-1))/SECTION_ALIGNMENT)*SECTION_ALIGNMENT)
