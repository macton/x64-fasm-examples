...
;   - http://stackoverflow.com/questions/17456372/create-and-use-sections-for-pe-file-in-assembly-nasm
...
IMAGE_OPTIONAL_HEADER:
  ...
  dq EXE.IMAGE_BASE               ; u64 ImageBase
  dd EXE.SECTION_ALIGNMENT        ; u32 SectionAlignment
  dd EXE.FILE_ALIGNMENT           ; u32 FileAlignment
  ...
  dd 0                            ; u32 Checksum
  dw .IMAGE_SUBSYSTEM_WINDOWS_CUI ; u16 Subsystem
...
TEXT:
  ...
  bar:
    ...
    lea rcx, [print_2]
    mov rdx, EXE.IMAGE_BASE + foo.return_addr
    call qword [printf]
...
IMPORT_MSVCRT_DLL:
  ...
  dd 0                       ; u32 TimeDateStamp
  dd 0                       ; u32 ForwarderChain
  dd MSVCRT_MODULE_NAME      ; u32 rvaModuleName
  dd MSVCRT_ADDRESS_TABLE    ; u32 rvaImportAddressTable
...
MSVCRT_ADDRESS_TABLE:
  printf dq IMPORT_NAMES.printf
  dq 0 ; NULL Terminator
