...
PHDR_BSS:
  ...
  dq  0                         ; u64 p_filesz
  ; dq  BSS.SIZE                  ; u64 p_memsz
  dq  0x1000000                 ; u64 p_memsz
...
TEXT:
  ...
  .DATA:
    ...
    align 8
    printf  dq ?
    print_1 db "%d = %s", 0x0A, 0
    print_2 db "%d = %s", 0x0A, 0
    status_OK   db "OK",0
